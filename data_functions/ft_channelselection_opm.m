function [channel] = ft_channelselection_opm(desired, datachannel, senstype)
  ...
  case{'quspin_g2'}  
      ...
      if ~isempty(dataoritype)
        ...
        labelmegtan = datachannel(strncmp('TAN', dataoritype, 3));
          ...
          ft_warning(['Please specify a Fieldtrip structure with '...
              'an hdr.fieldori field']);
      end
...
findmegtan     = find(strcmpi(channel, 'TAN'));
findmegrad     = find(strcmpi(channel, 'RAD'));
